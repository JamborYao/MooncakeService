...
namespace MooncakeTool
{
    ...
    public partial class AzureReportEntities : DbContext
    {
        ...
        public DbSet<CodeOperation> CodeOperations { get; set; }
        public DbSet<CodeState> CodeStates { get; set; }
        ...
        public virtual ObjectResult<MSDNPageView_Result> MSDNPageView(Nullable<System.DateTime> startdate, Nullable<System.DateTime> enddate)
        {
            var startdateParameter = startdate.HasValue ?
                new ObjectParameter("startdate", startdate) :
                new ObjectParameter("startdate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MSDNPageView_Result>("MSDNPageView", startdateParameter, enddateParameter);
        }
